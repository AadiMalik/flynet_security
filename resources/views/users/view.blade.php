                        ...
                        <div class="card">
                              ...
                              <div class="card-body">
                                    <div class="row">
                                          ...
                                          <div class="col-md-12">
                                                <b>Email:</b><br>
                                                <span>sophia.davis@example.com</span>
                                          </div>
                                          <div class="col-md-12">
                                                <b>Phone:</b><br>
                                                <span>(555) 111-2233</span>
                                          </div>
                                          <div class="col-md-12">
                                                <b>Role:</b><br>
                                                <span>Support</span>
                                          ...
                                          <div class="col-md-12">
                                                <b>Address:</b><br>
                                                <span>98 Hill St, Denver, CO</span>
                                          </div>
                                    </div>
                                    <div class="row mt-2">
                                          <div class="col-lg-12 text-right">
                                                <a class="btn btn-warning btn-sm" href="{{ url('user/create') }}">
                                                      <i class="fa fa-edit text-white mr-2"></i> Edit User
                                                </a>
                                          </div>
                                    </div>
                              </div>
